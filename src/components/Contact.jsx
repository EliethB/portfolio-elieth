  ...
  return (
    <div className="min-h-screen flex flex-col md:flex-row">
      <div className="flex flex-col items-center justify-center w-full md:w-1/2 p-8">
        <h1 className="text-left font-black text-6xl text-white shadow-text-white underline decoration-sky-500/30 mb-6">
          Let's talk!
        </h1>
        <div className="flex flex-col mb-4">
          <div className="flex items-center mb-2">
            ...
            <a
              ...
              href="mailto:eliethbarquero01@gmail.com"
              target="_blank"
          ...
          <div className="flex items-center mb-2">
            ...
            <a
              className="text-white"
              href="https://www.linkedin.com/in/elieth-barquero-2b148126a"
              target="_blank"
              rel="noopener noreferrer"
            >
              Elieth Barquero
          ...
          <div className="flex items-center mb-4">
            <FaFile className="text-3xl text-white mr-2" />
            <a
              className="text-white"
              href={cv}
              target="_blank"
